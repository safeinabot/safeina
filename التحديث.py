...
UPSTREAM_REPO = "https://github.com/safeinabot/safeinabot"
...
async def print_changelogs(event, ac_br, changelog):
    changelog_str = f"𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝑺𝑨𝑭𝑬𝑰𝑵𝑨 𖠢 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n** ⪼ يوجـد تحـديث جديد لسورس سفينه ༗.**\n\n`{changelog}`\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n 𓆰 𝙎𝙊𝙐𝙍𝘾𝞝 𝑺𝑨𝑭𝑬𝑰𝑵𝑨 𖠢- @safeina1 𓆪"
...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            await event.edit(f"{txt}\n" "بيانات اعتماد هيروكو غير صالحة لتنصيب سفينه")
            return repo.__del__()
        await event.edit(
            "**تنصيب تحديث سفينه قيد التقدم ، يرجى الانتظار حتى تنتهي العملية ، وعادة ما يستغرق التحديث من 4 إلى 5 دقائق.**"
        )
        ups_rem.fetch(ac_br)
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit(
        "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝑺𝑨𝑭𝑬𝑰𝑵𝑨 𖠢 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم التحديث بنجاح ✅**\n ** جارٍ إعادة تشغيل بوت سفينه ، انتظر 𓆰.**"
    )
...
async def upstream(event):
    "بالنسبة لأمر التحديث ، تحقق مما إذا كان بوت سفينه محدثًا ، أو قم بالتحديث إذا تم بتحديثه"
    ...
    if HEROKU_API_KEY is None or HEROKU_APP_NAME is None:
        return await edit_or_reply(
            event,
            "𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝑺𝑨𝑭𝑬𝑰𝑵𝑨 𖠢 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n** ⪼ اضبط المتغيرات المطلوبة أولاً لتحديث بوت سفينه 𓆰،**",
        )
    try:
    ...
    if conf == "البوت":
        await event.edit(
            "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 safeina  - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ يتم تنصيب التحديث  انتظر 🌐 𓆰،**"
        )
        await deploy(event, repo, ups_rem, ac_br, txt)
        return
    if changelog == "" and not force_update:
        await event.edit(
            "\n𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 safeina   - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ سورس سفينه محدث لأخر اصدار ༗. **"
        )
        return repo.__del__()
    ...
    if conf == "الان":
        await event.edit(
            "𓆰 𝗦𝗢𝗨𝗥𝗖?? Safeina 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ يتم تحديث بوت سفينه انتظر 🌐..𓆰،**"
        )
