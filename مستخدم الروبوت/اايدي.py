# whois code for zed edit by ~ @safeina1
...
async def fetch_info(replied_user, event):
    ...
    rotbat = "「من مطـورين السورس 𓄂𓆃」" if user_id == 1924763504or user_id == 1924763504 else (".「  العضـو 𓅫  」.") 
    rotbat = ".「 مـالك الحساب 𓀫 」." if user_id == (await event.client.get_me()).id and user_id != 1924763504 and user_id != 1924763504 else rotbat
    ...
    caption += f"<b> ٴ•━─━─━─━─━─━─━─━─━• </b>\n"
    caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝𝑺𝑨𝑭𝑬𝑰𝑵𝑨 𖠢𓆪 </b> - @safeina1 "
